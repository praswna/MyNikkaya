...
export function getTextMetrics(text: string): TextMetrics {
  ...
  if (len > 180) return { fontSize: 15, lineHeight: "1.7" };
  if (len > 140) return { fontSize: 16, lineHeight: "1.8" };
  if (len > 80)  return { fontSize: 18, lineHeight: "1.8" };
  if (len > 40)  return { fontSize: 19, lineHeight: "1.9" };
  return { fontSize: 20, lineHeight: "1.9" };
}
