...
export const THEMES = {
  dark: {
    ...
    text: "#F5F0E8",            // 본문 텍스트 색상
    textMuted: "#B8A898",       // 보조 텍스트 색상 (카테고리, 안내문 등)
    ...
    buttonIcon: "#B8A898",      // 하단 버튼 아이콘 색상
  ...
  light: {
    ...
    text: "#2C2416",            // 본문 텍스트 색상
    textMuted: "#7A6248",       // 보조 텍스트 색상
    ...
    buttonIcon: "#5C4A32",      // 하단 버튼 아이콘 색상
